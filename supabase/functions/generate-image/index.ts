    ...
    const response = await fetch("https://ai.gateway.lovable.dev/v1/chat/completions", {
      ...
      body: JSON.stringify({
        ...
        messages: [
          {
            role: "user",
            content: `Generate a photorealistic, high-quality image: ${prompt}. The image should be professional, detailed, and visually stunning.${aspectRatio ? ` Aspect ratio: ${aspectRatio}.` : ''}`
          }
        ],
